...
public class PlayerNBTManager {
    ...
    public void a(EntityPlayer entityplayer) {
        try {
            ...
            File file2 = new File(this.b, entityplayer.as + ".dat");
            ...
            a.warning("Failed to save player data for " + entityplayer.as);
        }
    }

    public void b(EntityPlayer entityplayer) {
        try {
            File file1 = new File(this.b, entityplayer.as + ".dat");
            ...
            a.warning("Failed to load player data for " + entityplayer.as);
        }
    }
}
