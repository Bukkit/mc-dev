...
public class PathfinderGoalPassengerCarrotStick extends PathfinderGoal {
    ...
    public void e() {
        ...
        if (!entityhuman.abilities.canInstantlyBuild && this.c >= this.b * 0.5F && this.a.aC().nextFloat() < 0.006F && !this.d) {
    ...
    public void g() {
        this.d = true;
        this.e = 0;
        this.f = this.a.aC().nextInt(841) + 140;
    }
