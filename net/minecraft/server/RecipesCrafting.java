...
public class RecipesCrafting {
    ...
    public void a(CraftingManager craftingmanager) {
        ...
        craftingmanager.registerShapedRecipe(new ItemStack(Block.TRAPPED_CHEST), new Object[] { "#-", Character.valueOf('#'), Block.CHEST, Character.valueOf('-'), Block.TRIPWIRE_SOURCE});
        ...
        craftingmanager.registerShapedRecipe(new ItemStack(Block.QUARTZ_BLOCK, 1, 1), new Object[] { "#", "#", Character.valueOf('#'), new ItemStack(Block.STEP, 1, 7)});
        craftingmanager.registerShapedRecipe(new ItemStack(Block.QUARTZ_BLOCK, 2, 2), new Object[] { "#", "#", Character.valueOf('#'), new ItemStack(Block.QUARTZ_BLOCK, 1, 0)});
        ...
        craftingmanager.registerShapedRecipe(new ItemStack(Block.NETHER_BRICK, 1), new Object[] { "NN", "NN", Character.valueOf('N'), Item.NETHER_BRICK});
    }
}
