                ...
                for (; l < i1; ++l) {
                    ...
                    if (flag || random.nextInt(4) != 0) {
                        ...
                        if (d0 >= d4 - 16.0D - d6 * 2.0D && d2 >= d5 - 16.0D - d6 * 2.0D && d0 <= d4 + 16.0D + d6 * 2.0D && d2 <= d5 + 16.0D + d6 * 2.0D) {
                            ...
                            for (k3 = l1; !flag1 && k3 < i2; ++k3) {
                                for (int i4 = l2; !flag1 && i4 < i3; ++i4) {
                                    for (int j4 = k2 + 1; !flag1 && j4 >= j2 - 1; --j4) {
                                        j3 = k3 * 16 + i4;
                                    ...
                                    for (l3 = l2; l3 < i3; ++l3) {
                                        ...
                                        if (d12 * d12 + d13 * d13 < 1.0D) {
                                            for (int l4 = k2 - 1; l4 >= j2; --l4) {
                                                ...
                                                if ((d12 * d12 + d13 * d13) * (double) this.a[l4] + d14 * d14 / 6.0D < 1.0D) {
                                                    byte b0 = abyte[k4];
                                                    ...
                                                    if (b0 == Block.STONE.id || b0 == Block.DIRT.id || b0 == Block.GRASS.id) {
                                                        if (l4 < 10) {
                                                            ...
                                                            abyte[k4] = 0;
                                                            if (flag2 && abyte[k4 - 1] == Block.DIRT.id) {
