...
public abstract class GenLayer {
    ...
    public static GenLayer[] a(long i) {
        ...
        genlayerzoom = new GenLayerZoom(2002L, genlayerisland);
        genlayerisland = new GenLayerIsland(3L, genlayerzoom);
        genlayerzoom = new GenLayerZoom(2003L, genlayerisland);
        genlayerisland = new GenLayerIsland(3L, genlayerzoom);
        genlayerzoom = new GenLayerZoom(2004L, genlayerisland);
        genlayerisland = new GenLayerIsland(3L, genlayerzoom);
        byte b0 = 4;
        GenLayer genlayer = GenLayerZoom.a(1000L, genlayerisland, 0);
        GenLayerRiverInit genlayerriverinit = new GenLayerRiverInit(100L, genlayer);

        genlayer = GenLayerZoom.a(1000L, genlayerriverinit, b0 + 2);
        GenLayerRiver genlayerriver = new GenLayerRiver(1L, genlayer);
        GenLayerSmooth genlayersmooth = new GenLayerSmooth(1000L, genlayerriver);
        GenLayer genlayer1 = GenLayerZoom.a(1000L, genlayerisland, 0);
        ...
        return new GenLayer[] { genlayerrivermix, genlayerzoomvoronoi, genlayer2, genlayer3};
    }
